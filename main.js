!(function (e) {
  ...
  function (e, t, n) {
      ...
      edit() {
        ...
        document
          ...
          .addEventListener("submit", (t) => {
            ...
            if ("" === n.value) return void alert("La tarea debe tener un nombre.");
            const r = document.getElementById("task-date-edit");
            if ("" === r.value) return void alert("Por favor elige una fecha límite");
    ...
    document.getElementById("form-folder").addEventListener("submit", (e) => {
      ...
      if ("" === t.value) return void alert("La carpeta debe tener un nombre.");
    ...
    document.getElementById("form-task").addEventListener("submit", (e) => {
      ...
      if ("" === t.value) return void alert("La tarea debe tener un nombre.");
      const n = document.getElementById("task-date");
      if ("" === n.value) return void alert("Por favor elige una fecha límite");
